                ...
                <table class="items-center bg-transparent w-full border-collapse">
                    ...
                    @foreach($periodes as $periode)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('program-studi.riwayat.pengajuan', ['periode_id' => $periode->periode_id]) }}" class="bg-blue-500 text-white active:bg-blue-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                    Lihat Pengajuan
                                </a>
                            </td>
                        </tr>
